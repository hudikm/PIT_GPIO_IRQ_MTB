...
/*! @name PORTA5 (number 31), J1[12]/D5
  @{ */
#define BOARD_INITPINS_INPUT_PIN_GPIO GPIOA /*!<@brief GPIO device name: GPIOA */
#define BOARD_INITPINS_INPUT_PIN_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_INITPINS_INPUT_PIN_PIN 5U     /*!<@brief PORTA pin index: 5 */
                                            /* @} */
