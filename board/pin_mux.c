...
board: FRDM-KL25Z
pin_labels:
- {pin_num: '31', pin_signal: PTA5/USB_CLKIN/TPM0_CH2, label: 'J1[12]/D5', identifier: INPUT_PIN}
...
- pin_list:
  ...
  - {pin_num: '53', peripheral: GPIOB, signal: 'GPIO, 18', pin_signal: TSI0_CH11/PTB18/TPM2_CH0, direction: OUTPUT, gpio_init_state: 'false', drive_strength: low}
  - {pin_num: '31', peripheral: GPIOA, signal: 'GPIO, 5', pin_signal: PTA5/USB_CLKIN/TPM0_CH2, direction: INPUT, gpio_interrupt: kPORT_InterruptLogicZero, pull_enable: enable}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPINS_INPUT_PIN_GPIO, BOARD_INITPINS_INPUT_PIN_PIN, &INPUT_PIN_config);
    ...
    const port_pin_config_t INPUT_PIN = {/* Internal pull-up resistor is enabled */
                                         kPORT_PullUp,
    ...
    PORT_SetPinConfig(BOARD_INITPINS_INPUT_PIN_PORT, BOARD_INITPINS_INPUT_PIN_PIN, &INPUT_PIN);

    /* Interrupt configuration on PORTA5 (pin 31): Interrupt when logic zero */
    PORT_SetPinInterruptConfig(BOARD_INITPINS_INPUT_PIN_PORT, BOARD_INITPINS_INPUT_PIN_PIN, kPORT_InterruptLogicZero);
